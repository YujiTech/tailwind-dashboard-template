                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              {isActive ? (
  <div className={`some-static-class ${isActive ? 'some-dynamic-class' : ''}`}>
    {/* ... other code ... */}
  </div>
) : (
  <Link to="#" className="text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
