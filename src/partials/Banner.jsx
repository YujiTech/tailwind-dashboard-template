...
function Banner() {
  ...
  const liteLink =
    template === 'laravel'
      ? 'https://github.com/YujiTech/laravel-tailwindcss-admin-dashboard-template'
      : 'https://github.com/YujiTech/tailwind-dashboard-template';
